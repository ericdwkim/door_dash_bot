...
stdout_file_path=f"/Users/ekim/workspace/txb/dd-bot/dev/build/logs/stdout/${today}_out.log"
stderr_file_path=f"/Users/ekim/workspace/txb/dd-bot/dev/build/logs/stderr/${today}_err.log"
